            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="mr-1">Hello,
                  <span class="user-name text-bold-700" id="nama">John Doe</span>
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" id="btn_gpass" href="#"><i class="fas fa-exchange-alt"></i> Ganti Password</a>
                <a class="dropdown-item" id="btn_logout" href="#"><i class="fas fa-power-off"></i> Logout</a>
              </div>
            </li>
          </ul>
        </div>
      ...
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title" data-i18n="nav.templates.main">Templates</span></a>
          <ul class="menu-content">
            ...
            <li><a class="menu-item" href="#">Log User</a></li>
          </ul>
        </li>
      </ul>
    </div>
